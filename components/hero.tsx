...
export function Hero() {
  return (
    <section className="relative w-full mb-8">
      {/* Cover Image */}
      <div className="w-full h-48 md:h-64 overflow-hidden border-b border-white/5 relative">
        <img
          src="https://images.unsplash.com/photo-1579783902614-a3fb3927b6a5?ixlib=rb-4.1.0&q=85&fm=jpg&crop=entropy&cs=srgb&w=4800"
          alt="Banner"
          className="w-full h-full object-cover object-center opacity-80 animate-in fade-in zoom-in duration-700 grayscale hover:grayscale-0 transition-all"
        />
      </div>
        ...
        <div className="flex flex-col items-start -mt-12 md:-mt-16 ml-4 relative z-10">
          ...
          <div className="w-full flex justify-between items-end mt-6">
            ...
            <div className="flex gap-3 mb-2">
              ...
              <a href="https://x.com/piyyu" target="_blank" className="group relative p-3 rounded-full bg-[#222] border border-[#333] border-b-4 border-b-[#111] text-[#888] hover:text-white hover:border-b-[#111] active:border-b-0 active:translate-y-1 transition-all duration-100">
